...
plot "skew_mean_sd.txt" using 1:2 title 'Means(Cosine)' with lines,\
     "skew_mean_sd.txt" using 1:4 title 'Means(Euclidean)' with lines,\
...
plot "maxlink_mean_sd.txt" using 1:2 title 'Means(Cosine)' with lines,\
     "maxlink_mean_sd.txt" using 1:4 title 'Means(Euclidean)' with lines,\
